...
def load_data():
    f = open(r"C:\Users\Accuser\CS480\Reduced Data\Data and Scores csv\Correct_data_S1.csv")
    csv_f = csv.reader(f)
    ...
    f = open(r"C:\Users\Accuser\CS480\Reduced Data\Data and Scores csv\Correct_score_S1.csv")
    csv_f = csv.reader(f)
    ...
    f = open(r"C:\Users\Accuser\CS480\Reduced Data\Data and Scores csv\Incorrect_data_S1.csv")
    csv_f = csv.reader(f)
    ...
    f = open(r"C:\Users\Accuser\CS480\Reduced Data\Data and Scores csv\Incorrect_score_S1.csv")
    csv_f = csv.reader(f)
